export class Pokemon{
  constructor(name, number, sprite, flavortext, type, height, weight){
    this.name = name;
    this.number = number;
    this.sprite = sprite;
  ...
  pokemonNameCall(pokemonName){
    ...
    pokeNamePromise.then(function(response){
  ...
  pokemonSpeciesCall(pokemonName){
    ...
    pokeSpeciesPromise.then(function(response){
      let pokemonCalled = JSON.parse(response);
      console.log(pokemonCalled);
  ...
  pokemonTypeCall(pokemonType){
    ...
    pokeTypePromise.then(function(response){
